...
public class SwitchConfigController {
    ...
    @PostMapping("/query")
    public BaseResult<List<SwitchConfig>> add(@RequestBody SwitchConfigParam switchConfigParam) {
    	return switchConfigService.querySwitchConfig(switchConfigParam.getPlatform(), switchConfigParam.getBusinessType());
    }
