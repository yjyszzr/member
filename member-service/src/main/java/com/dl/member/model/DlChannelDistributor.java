...
public class DlChannelDistributor {
	 ...
	 * 获取 渠道分销者(店员)id
	 *
	 * @return channel_distributor_id - 渠道分销者(店员)id
	 */
	 ...
	 */
	public Double getDistributorCommissionRate() {
	 ...
	 * 设置分销者佣金比例
	 *
	 * @param distributorCommissionRate
	 *            分销者佣金比例
	 */
	public void setDistributorCommissionRate(Double distributorCommissionRate) {
